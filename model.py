...
class Facemask_LossBranch(nn.Module):
    def __init__(self,in_channels,out_channels=64,num_classes=3):
        super(Facemask_LossBranch, self).__init__()
...
class FacemaskNet(nn.Module):
    def __init__(self,num_classes = 3):
        ...
        self.c1 = nn.Sequential(
            SeparableConv2d(3,64,kernel_size=3,stride=2,padding=0),
            nn.ReLU6(64)
        )
        self.c2 = nn.Sequential(
            SeparableConv2d(64,64,kernel_size=3,stride=2,padding=0),
            nn.ReLU6(64)
        )
        ...
        self.lossbranch1 = Facemask_LossBranch(64,num_classes = self.num_classes)
        self.lossbranch2 = Facemask_LossBranch(64,num_classes = self.num_classes)
        self.lossbranch3 = Facemask_LossBranch(64,num_classes = self.num_classes)
        self.lossbranch4 = Facemask_LossBranch(64,num_classes = self.num_classes)
        self.lossbranch5 = Facemask_LossBranch(128,num_classes = self.num_classes)
        self.lossbranch6 = Facemask_LossBranch(128,num_classes = self.num_classes)
        self.lossbranch7 = Facemask_LossBranch(128,num_classes = self.num_classes)
        self.lossbranch8 = Facemask_LossBranch(128,num_classes = self.num_classes)
    def forward(self, x):
        c1 = self.c1(x)
        c2 = self.c2(c1)
